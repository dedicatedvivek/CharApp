...
$total_forms = Applicants::where('category','financial')->count();

       ?>

<?php
$accepted = Applicants::where('sanction_status','Accepted')->where('category','financial')->count();
...
<div class="val-description"> FINANCIAL APPLICANTS </div>
<div class="val-description2"> FINANCIAL FORMS ACCEPTED </div>
<div class="val-description3"> FINANCIAL FORMS PENDING/REJECTED </div>
...
$sql = "SELECT id,formnum,firstname, lastname,age,gender,nationality,address,city,pincode,category,email,phone,sanction_status FROM applicants where category = 'financial'";

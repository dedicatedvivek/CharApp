...
$total_forms = Applicants::where('category','educational')->count();

       ?>

<?php
$accepted = Applicants::where('sanction_status','Accepted')->where('category','educational')->count();
...
$sql = "SELECT id,formnum,firstname, lastname,age,gender,nationality,address,city,pincode,category,email,phone,sanction_status FROM applicants where category = 'educational'";
